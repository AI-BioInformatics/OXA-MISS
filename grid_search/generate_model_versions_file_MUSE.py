...
changes_template = {
    ...
    'title': ["{model_name}_augtrain_{tumor_type}"], 
    ...
    'model.kwargs.embedding_size': [64], #256, 512 da testare -- 128 prima
    'model.kwargs.ffn_layers': [2],
    'model.kwargs.gnn_layers': [2],
    'model.kwargs.dropout': [0.15],
    'model.kwargs.output_size': [4],
    ...
    # --- OPTIMIZER ---
    'optimizer.learning_rate': [0.00005], #, ,  da lanciare 0.001
...
tumor_types =  ["OV" ,"LUAD","HNSC","STAD","BRCA"] # ,"LUAD","HNSC","STAD","BRCA"] #["OV"] ## ["PDS"] #, "NACT_primary"]#["BLCA", "BRCA", "COAD", "HNSC", "KIRC","KIRP" ,"LUAD", "LUSC","OV","STAD"] #"BRCA" manca solo seed 44 (running) "LUAD", "KIRP" devo sistemare i fold
