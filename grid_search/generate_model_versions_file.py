...
model_name = "Custom_Multimodal_XA_v2" #Custom_Multimodal_XA
...
changes_template = {
    ...
    'title': ["OXA-MISS_augtrain_{tumor_type}"], #custom_multimodal_XA_MISSING_MOD_RATE_kfold_5_all_tissues
    ...
    # --- K-FOLD SPLIT ---
    'data_loader.KFold.splits':["/work/H2020DeciderFicarra/D2_4/Development/MultimodalDecider/splits/splits_train_val_test/{tumor_type}","/work/H2020DeciderFicarra/D2_4/Development/MultimodalDecider/splits/aug_splits_train_val_test/{tumor_type}"],   #["/work/H2020DeciderFicarra/D2_4/Development/MultimodalDecider/utils/splits_train_val_test/{tumor_type}"], #
    ...
    'missing_modality_test.scenarios': [['genomics_miss_25','genomics_miss_100','wsi_miss_100','genomics_miss_50','genomics_miss_75','wsi_miss_25','wsi_miss_50','wsi_miss_75']],  # Lista vuota o nomi


    # --- MODEL ---
    'model.name': ["Custom_Multimodal_XA_v2"],
...
tumor_types = ["BRCA"] #["LUAD","HNSC","STAD","BRCA", "BLCA","COAD","KIRC","KIRP","LUSC","OV"] #"OV" , #["OV"] ## ["PDS"] #, "NACT_primary"]#["BLCA", "BRCA", "COAD", "HNSC", "KIRC","KIRP" ,"LUAD", "LUSC","OV","STAD"] #"BRCA" manca solo seed 44 (running) "LUAD", "KIRP" devo sistemare i fold
