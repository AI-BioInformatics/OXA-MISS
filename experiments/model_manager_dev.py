...
class ModelManager():
    def __init__(self,
        ...
        if self.config.trainer.do_kfold and self.config.data_loader.KFold.internal_val_size > 0 and self.config.trainer.epochs // 100 == 0:
            self.config.trainer.epochs *= 10 
