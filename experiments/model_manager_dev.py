...
from .utils import accuracy_confusionMatrix_plot, kfold_results_merge, move_to_device, ResultsStore
import os
...
class ModelManager():
    ...
    def evaluate(self, test_dataloader, 
        ...
        if log_aggregated:
            aggregated_metrics = self.results_store.compute_aggregated_metrics(scenario, task_type)
            self._log_aggregated_metrics(aggregated_metrics, scenario, task_type)
            logs = aggregated_metrics
            if log_on_telegram:
            ...
            if print_demo_results:
                ...
                print("\n\n\n\n\n\n\n\n\n")
                print("Demo results:\n")
                print(df_old_records[["ID", "model_name", "dataset_name", "model_version", "modality_setting", "test_scenario", "c-index_mean", "c-index_std", "c-index_list"]].round(3).to_string(index=False))
                print("\n\n\n")
            ...
            n69bgwyx   OXA_MISS         KIRC    Lowest_Validation_Loss_Model         complete           complete         0.802        0.082  [0.792, 0.75, 0.684, 0.875, 0.909]
            n69bgwyx   OXA_MISS         KIRC Highest_Validation_Metric_Model         complete           complete         0.827        0.113    [0.75, 0.909, 1.0, 0.792, 0.684]
            n69bgwyx   OXA_MISS         KIRC                Last_Epoch_Model         complete           complete         0.958        0.084         [1.0, 0.789, 1.0, 1.0, 1.0]
            n69bgwyx   OXA_MISS         KIRC    Lowest_Validation_Loss_Model         complete       wsi_miss_100         0.691        0.175      [0.625, 0.75, 1.0, 0.579, 0.5]
            n69bgwyx   OXA_MISS         KIRC Highest_Validation_Metric_Model         complete       wsi_miss_100         0.741        0.184      [0.875, 0.579, 0.75, 0.5, 1.0]
            n69bgwyx   OXA_MISS         KIRC                Last_Epoch_Model         complete       wsi_miss_100         0.918        0.144       [1.0, 0.958, 1.0, 1.0, 0.632]
            n69bgwyx   OXA_MISS         KIRC    Lowest_Validation_Loss_Model         complete  genomics_miss_100         0.712        0.187 [0.708, 0.364, 0.875, 0.737, 0.875]
            n69bgwyx   OXA_MISS         KIRC Highest_Validation_Metric_Model         complete  genomics_miss_100         0.747        0.215   [1.0, 0.708, 0.364, 0.789, 0.875]
            n69bgwyx   OXA_MISS         KIRC                Last_Epoch_Model         complete  genomics_miss_100         0.853        0.121      [0.75, 1.0, 0.727, 1.0, 0.789]
