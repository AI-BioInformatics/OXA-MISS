...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--demo_inference",  action='store_true')          
            ...
            for i_scenario, scenario in enumerate(test_scenarios):   
                ...
                for i, split_path in enumerate(splits):            
                    ...
                    mm.evaluate(test_dataloader, 
                                ...
                                print_demo_results = args.demo_inference and i_scenario==len(test_scenarios)-1 and i==len(splits)-1 ,
                                is_demo=args.demo_inference,
                                repo_path=repo_dir)
