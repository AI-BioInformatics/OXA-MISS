    ...
    def evaluate(self, test_dataloader, 
        ...
        if log_aggregated:
            ...
            if print_demo_results:
                ...
                print(df_old_records_filtered[["ID", "model_name", "dataset_name", "model_version", "modality_setting", "c-index", "test_scenario", "c-index_mean", "c-index_std", "c-index_list"]].round(3).to_string(index=False))
                print("\n\n\n")
